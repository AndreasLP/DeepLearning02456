...
def make_gennet(obs_shape=[9, 84, 84], num_filters=32, num_keypoints=10, encoded_image_size=8):
...
def make_imm(obs_shape=[3, 84, 84], encoder_feature_dim=50, num_layers=4, num_filters=32, num_keypoints=10, sigma=0.1):
